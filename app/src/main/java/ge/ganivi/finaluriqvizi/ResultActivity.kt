...
import ge.ganivi.finaluriqvizi.databinding.ActivityResultBinding
    ...
    private fun initializeViews() {
        activityResultBinding.apply {
            ...
            if (totalScore >= 6) {
                ...
                Toast.makeText(this@ResultActivity, "ვაუ :O", Toast.LENGTH_SHORT).show()
            } else {
                emojiReactionImg.setImageResource(R.drawable.angry)
                Toast.makeText(this@ResultActivity, "უნდა განვითარდე", Toast.LENGTH_SHORT).show()
            }
